  ...
  const navHTML = `
    ...
    <div style="background: #0f172a; padding: 1rem; border-bottom: 0.5px solid #334155;">
      <div style="max-width: 1100px; margin: 0 auto;">
        ...
        <select id="yearSelector" style="max-width: 200px; width: 100%; padding: 0.75rem; background: #1e293b; color: #e2e8f0; border: 0.5px solid #334155; border-radius: 6px; font-size: 14px;">
          ${yearOptions}
        </select>
      </div>
    </div>
